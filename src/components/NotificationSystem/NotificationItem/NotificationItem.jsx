...
class NotificationItem extends Component {
  constructor(props) {
    ...
    this.dismissTime = parseInt(this.notification.autoDismiss, 10) * 1000;
  ...
  getActionButton() {
    return (
      <div
        ...
        style={this.styles.get('actionWrapper')}
      >
        <button
          className="notification-action-button"
          onClick={this.defaultAction}
          style={this.styles.get('action')}
        >
    ...
    if (this.props.allowHTML) {
      return (
        <div
          ...
          style={this.styles.get('messageWrapper')}
  ...
  getDismissButton() {
    return (
      <span
        className="dib notification-dismiss"
